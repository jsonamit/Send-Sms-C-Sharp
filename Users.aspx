                    ...
                    <table class="table table-striped table-advance table-hover">
                        <tbody>
                            ...
                            <asp:Repeater ID="RpViewUsers" runat="server">
                                <ItemTemplate>
                                    <tr>
                                        <td style="width: 13%;"><%#Eval("name") %></td>
                                        <td style="width: 12%;"><%#Eval("mobile") %></td>
                                        <td style="width: 16%;"><%#Eval("email") %></td>
                                        <td style="width: 16%;"><%#Eval("courses") %></td>
                                        <td style="width: 12%;"><%#Eval("payment") %></td>
                                        <td style="width: 16%;"><%#Eval("remain_payment") %></td>
                                       <%-- <td>
                                            	<div class="btn-group">
												<asp:PlaceHolder ID="viewPlaceHolder" runat="server" Visible='<%# Eval(!TestPayment().ToString())=="0" %>'>
													<a class="btn btn-success" "><i></i>Done</a>
												</asp:PlaceHolder>
												<asp:PlaceHolder ID="modifyPlaceHolder" runat="server" Visible='<%# Eval("remain_payment").ToString()=="0" %>'>
													<a class="btn btn-success" ><i></i>Modify</a>
												</asp:PlaceHolder>
